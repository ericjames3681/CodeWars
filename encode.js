...
// For the sake of simplicity, you can assume that any
// numbers passed into the function will correspond to vowels.
let codeObj = {
  a: 1,
  e: 2,
  i: 3,
...
function encode(string) {
  return string.replace(/[aeiou]/g, (val) => codeObj[val]);
}

function decode(string) {
  return string.replace(/[1-5]/g, (val) => Object.keys(codeObj)[--val]);
}
